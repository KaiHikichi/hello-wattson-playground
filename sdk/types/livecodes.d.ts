...
declare module 'livecodes/models' {
    ...
    /**
        ...
        */
    export type AppLanguage = 'auto' | 'ar' | 'bn' | 'de' | 'en' | 'es' | 'fa' | 'fr' | 'hi' | 'hu' | 'id' | 'it' | 'ja' | 'nl' | 'pt' | 'tr' | 'ru' | 'ur' | 'zh-CN';
    /**
    ...
    /**
        ...
        */
    export type WatchFns = WatchLoad | WatchReady | WatchCode | WatchRun | WatchConsole | WatchTests | WatchDestroy;
    /**
    ...
    /**
        ...
        */
    export type WatchRun = (event: 'run', fn: (data: {
            code: Code;
            config: Config;
    }) => void) => {
            remove: () => void;
...
declare module 'livecodes/preact' {
    /**
    ...
    export type { Code, Config, EmbedOptions, Language, Playground } from 'livecodes/models';
    /**
...
declare module 'livecodes/solid' {
    /**
    ...
    /**
        ...
        * ```
        */
    const LiveCodes: Component<Props>;
    export default LiveCodes;
}
declare module 'livecodes/svelte' {
    /**
        ...
        */
    import type { EmbedOptions, Playground } from 'livecodes/models';
    export { createPlayground } from 'livecodes';
    export type { Code, Config, EmbedOptions, Language, Playground } from 'livecodes/models';
    /**
    ...
    /**
        ...
        * ```
        */
    const LiveCodes: import('svelte').Component<Props, {}, ''>;
...
declare module 'livecodes/web-components' {
    /**
