"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([["5302"],{94458:function(e,s,i){i.r(s),i.d(s,{default:()=>g,frontMatter:()=>a,metadata:()=>n,assets:()=>d,lessConfig:()=>c,toc:()=>h,contentTitle:()=>o});var n=JSON.parse('{"id":"languages/less","title":"Less","description":"Less (Leaner Style Sheets) is a CSS preprocessor that extends CSS with variables, nesting, mixins, functions and operations. It uses a CSS-like syntax with curly braces and semicolons, so every valid CSS stylesheet is also valid Less.","source":"@site/docs/languages/less.mdx","sourceDirName":"languages","slug":"/languages/less","permalink":"/docs/languages/less","draft":false,"unlisted":false,"editUrl":"https://github.com/live-codes/livecodes/tree/develop/docs/docs/languages/less.mdx","tags":[],"version":"current","frontMatter":{},"sidebar":"docsSidebar","previous":{"title":"Julia","permalink":"/docs/languages/julia"},"next":{"title":"Lightning CSS","permalink":"/docs/languages/lightningcss"}}'),l=i("85893"),t=i("50065"),r=i("11802");let a={},o="Less",d={},c={activeEditor:"style",markup:{language:"html",content:`<div class="container">
  <h1>Hello, Less!</h1>
