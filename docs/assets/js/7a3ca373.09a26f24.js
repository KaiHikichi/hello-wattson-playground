"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([["7773"],{7512:function(e,s,n){n.r(s),n.d(s,{Code:()=>p,AppVersionLink:()=>h,default:()=>v,GetPermanentUrl:()=>u,frontMatter:()=>d,metadata:()=>t,assets:()=>c,FullCode:()=>m,toc:()=>f,contentTitle:()=>l});var t=JSON.parse('{"id":"features/permanent-url","title":"Permanent URL","description":"Any specific version of LiveCodes app can be accessed through the permanent unique URL:","source":"@site/docs/features/permanent-url.mdx","sourceDirName":"features","slug":"/features/permanent-url","permalink":"/docs/features/permanent-url","draft":false,"unlisted":false,"editUrl":"https://github.com/live-codes/livecodes/tree/develop/docs/docs/features/permanent-url.mdx","tags":[],"version":"current","frontMatter":{},"sidebar":"docsSidebar","previous":{"title":"Read-Only","permalink":"/docs/features/read-only"},"next":{"title":"Data URLs","permalink":"/docs/features/data-urls"}}'),r=n("85893"),i=n("50065"),o=n("87262"),a=n("31705");let d={},l="Permanent URL",c={},h=()=>{let{siteConfig:e}=(0,o.Z)();return(0,r.jsxs)("a",{href:`https://v${e.customFields.appVersion}.livecodes.io`,target:"\\_blank",children:["https://v",e.customFields.appVersion,".livecodes.io"]})},p=()=>{let{siteConfig:e}=(0,o.Z)();return(0,r.jsx)(a.Z,{title:"index.html",language:"html",children:`<div id="container"></div>
<script type="module">
...
</script>`})},u=()=>{let{siteConfig:e}=(0,o.Z)();return(0,r.jsx)(a.Z,{language:"js",children:`await livecodes.exec('showVersion');
...
`})},m=()=>{let{siteConfig:e}=(0,o.Z)();return(0,r.jsx)(a.Z,{title:"index.html",language:"html",children:`<div id="container"></div>
<script type="module">
  // specific SDK version
// highlight-next-line
  import { createPlayground } from 'https://cdn.jsdelivr.net/npm/livecodes@${e.customFields.sdkVersion}';
