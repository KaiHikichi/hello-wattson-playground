...
This allows code execute but prevents untrusted code from accessing the main app's cookies, localStorage, or DOM. All communication with the app uses `postMessage` with strict origin verification.
