...
You can export your locally stored data at any time using the [Backup](../docs/features/backup-restore.html.md) feature, which downloads a zip file of your projects, snippets, assets, templates, and settings.
