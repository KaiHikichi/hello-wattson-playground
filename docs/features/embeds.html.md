...
To embed a playground in a supported platform, paste a LiveCodes URL (**short** [share URL](./share.html.md) or a URL with [query params](../configuration/query-params.html.md)). The platform will automatically resolve the embed.
